...
class SlideVerifyWidget extends StatefulWidget{
  ...
  final double width;
   ...
   VoidCallback? verifySuccessListener;
      ...
      child: Container(
        ...
        child: Stack(
          children: <Widget>[
            ...
            Center(
              child: Text(verifySuccess?"簽到成功":"請按住滑塊，拖動到最右邊", style: TextStyle(color: verifySuccess?Colors.white:Colors.black54, fontSize: 14),),
            ),
            Positioned(
              top: 0,
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    // Image.asset("images/ic_next_primary.png", height: 16, width: 16,),
                    /// 因为向右箭头有透明边距导致两个箭头间隔过大，因此将第二个箭头向左偏移，如果切图无边距则不用偏移
                    // Transform(
                    //   transform: Matrix4.translationValues(-8, 0, 0),
                    //   child: Image.asset("images/huakuai_btn.png", height: 16, width: 16,),
                    // ),
                  ],
                ),
              ),
