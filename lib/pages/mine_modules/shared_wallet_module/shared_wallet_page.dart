  ...
  Widget buildAppBarBackground(BuildContext context) {
    return Column(
      children: [
        SizedBox(
          ...
          child: Stack(
            children: [
              ...
              Align(alignment: const Alignment(0, -0.25),child:  Image.asset('images/login_log.png',width: 150,height: 150,),),
              ...
              child:RichText(text: TextSpan(
                children: [
                  TextSpan(
                    ...
                    style: TextStyle(color: AppColor.themeTextColor,fontSize: 30,fontWeight: FontWeight.w700)
                  ),
        ...
        _sharedWalletModel?.data?.owner==null?SizedBox():Container(
          child: Text('提示:代幣與${_sharedWalletModel?.data?.owner?.walletExpireAt}過期',
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child:  CachedNetworkImage(imageUrl: '${Address.homeHost}/storage/${_sharedWalletModel?.data?.userList?[index].avatar}',
                    ...
                    Container(
                      ...
                      width: 100,
                      height: 20,
                      child:Text('${_sharedWalletModel?.data?.userList?[index].name}'),
                    )
                  ],
                ),
              ),
              isUnite==false?const SizedBox():GestureDetector(
               onTap: (){
                 Get.defaultDialog(title: '提示',middleText: '是否移除當前用戶',textCancel:'取消',textConfirm: '確定',onConfirm: (){
                   requestDataWithRemoveWallet('${_sharedWalletModel?.data?.userList?[index].id}');
                   requestDataWithWalletUser();
               ...
               child: Image.asset('images/ic_yichu.png',width: 20,height: 20,color: Colors.red,),
             )
            ],
          ),
        );
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text('金額 ${model.amount}',style: TextStyle(fontWeight: FontWeight.w700,
                    ...
                    Container(
                      ...
                      child: Text('      已購買與 \n ${model.createdAt}',style: TextStyle(color: Colors.white,fontSize: 13),),
                    )
                  ],
                )
            ),
