                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: CachedNetworkImage(
                        imageUrl:
                            "${Address.homeHost}/storage/${controller.userModel?.data?.avatar}",
                        placeholder: (context, url) =>
                            const CircularProgressIndicator(),
                        errorWidget: (context, url, error) =>
                            Image.asset('images/ic_placeholder_header.png'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
            ...
            GestureDetector(
              ...
              child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        I18nContent.changePasswordLabel,
                        style: TextStyle(
                            fontWeight: FontWeight.w700,
                            fontSize: 23,
                            color: AppColor.themeTextColor),
