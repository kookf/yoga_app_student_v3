    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Text(
            '已完成付款（待批核）',
            style: TextStyle(fontSize: 25, color: AppColor.themeTextColor),
          ),
          Image.asset(
            'images/ic_receipt_success.png',
            width: 160,
            height: 160,
          ),
          Text(
            'HK\$ ${widget.model?.data?.amount}',
            style: TextStyle(fontSize: 30, color: AppColor.themeTextColor),
          ),
          const SizedBox(
            height: 15,
          ),
          Text(
            '付款給',
            style: TextStyle(color: AppColor.registerBgColor, fontSize: 14),
          ),
          Center(
              child: SizedBox(
            // color: Colors.red,
                ...
                Column(
                  ...
                  children: [
                    Text(
                      'Momo Yoga',
                      style: TextStyle(
                          color: AppColor.themeTextColor, fontSize: 14),
                    ),
                    Text(
                      'info@momoyoga.com',
                      style: TextStyle(
